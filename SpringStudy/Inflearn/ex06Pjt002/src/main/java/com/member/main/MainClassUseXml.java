...
import com.member.assembler.StudentAssembler;
...
//		StudentAssembler assembler = new StudentAssembler();
		GenericXmlApplicationContext gtx = new GenericXmlApplicationContext("classpath:applicationContext.xml");
		COMInformationService cis = gtx.getBean("infoService", COMInformationService.class);
...
//		StudentRegisterService registerService = assembler.getRegisterService();
		...
		StudentRegisterService registerService = gtx.getBean("registerService",
...
//		StudentModifyService modifyService = assembler.getModifyService();
		...
		StudentModifyService modifyService = gtx.getBean("modifyService",
...
//		StudentSelectService selectService = assembler.getSelectService();
		...
		StudentSelectService selectService = gtx.getBean("selectService",
...
//		StudentAllSelectService allSelectService = assembler.getAllSelectService();
		...
		StudentAllSelectService allSelectService = gtx.getBean("allSelectService",
