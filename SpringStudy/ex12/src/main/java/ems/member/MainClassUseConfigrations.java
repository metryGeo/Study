...
import ems.member.configration.PracticeConfig1;
import ems.member.configration.PracticeConfig2;
import ems.member.configration.PracticeConfig3;
...
//		StudentAssembler assembler = new StudentAssembler();
		AnnotationConfigApplicationContext ctx = 
				new AnnotationConfigApplicationContext(PracticeConfig1.class, PracticeConfig2.class, PracticeConfig3.class);
...
//		StudentModifyService modifyService = assembler.getModifyService();
		...
		System.out.println("modifyService Done()...");
...
//		StudentSelectService selectService = assembler.getSelectService();
		...
		System.out.println("selectService Done()...");
